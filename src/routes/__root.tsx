...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Coco Sage App" },
      { name: "description", content: "Coco Sage Project" },
      { name: "author", content: "Coco Sage" },
      { property: "og:title", content: "Coco Sage App" },
      { property: "og:description", content: "Coco Sage Project" },
